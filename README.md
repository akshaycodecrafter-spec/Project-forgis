...
![FORGIS hero section showing the "TRAIN LIKE YOU MEAN IT." headline alongside a terminal demo panel that simulates booking a free trial session.](assets/forgis_hero.png)
*Hero with the "TRAIN LIKE YOU MEAN IT." headline, subtitle, and a live terminal-style demo of the free-trial booking flow.*

![FORGIS About and Programs sections, the latter showing the Strength, Conditioning, and Small Group program cards in a three-column grid.](assets/forgis_about_programs.png)
*The Club intro and the start of the Programs grid — Strength, Conditioning, and Small Group cards side-by-side.*

![FORGIS pricing section showing the three membership tiers (Foundation, Performance, P1 Coaching) with prices in AED per month.](assets/forgis_pricing.png)
*The Membership tier grid — Foundation (349 AED/mo), Performance (549 AED/mo), and P1 Coaching (1,450 AED/mo).*

![FORGIS contact section with Al Quoz address, hours, phone, and email, alongside a Book a Free Trial button and a Chat on WhatsApp button.](assets/forgis_contact.png)
